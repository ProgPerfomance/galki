...
import 'package:galki/presentation/main/home/challenge_review_view.dart';
                        ...
                        children: [
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              color: const Color(0xff0000001).withOpacity(0.1),
                              border: Border.all(
                                  color: const Color(0xffFFE2E5), width: 2),
                            ),
                            child: Row(
                          ...
                          GestureDetector(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                borderRadius: BorderRadius.circular(100),
                                color:
                                    const Color(0xff0000001).withOpacity(0.1),
                              ),
                              child: Center(
                                child:
